...
const std::string build_time {"2018/02/02 12:49:10"};
...
constexpr auto build_time {meevax::string::static_concat("2018/02/02 12:49:10")};
...
constexpr auto patch_version {meevax::string::static_concat("1")};

constexpr auto version {meevax::string::static_concat("0.3.1")};
