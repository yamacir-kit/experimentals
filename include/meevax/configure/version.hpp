...
const std::string build_time {"2017/11/09 23:55:59"};
...
constexpr auto build_time {meevax::static_concat("2017/11/09 23:55:59")};
constexpr auto build_type {meevax::static_concat("")};
