...
namespace meevax::type_traits
{
  ...
  */
  template <>
  class is_supports_prefix_decrement_operators<meevax::debug::dummy_enum>
  ...
  */
  template <>
  class is_supports_postfix_decrement_operators<meevax::debug::dummy_enum>
    : public std::true_type
  {};

  static_assert(
    meevax::type_traits::is_supports_decrement_operators<
...
static_assert(
  --(meevax::debug::dummy_enum {meevax::debug::dummy_enum::fuga})
