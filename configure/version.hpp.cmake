...
#else
constexpr auto project_name {meevax::string::static_concat("${PROJECT_NAME}")};

constexpr auto build_time {meevax::string::static_concat("${${PROJECT_NAME}_TIMESTAMP}")};
constexpr auto build_type {meevax::string::static_concat("${CMAKE_BUILD_TYPE}")};

constexpr auto major_version {meevax::string::static_concat("${PROJECT_VERSION_MAJOR}")};
constexpr auto minor_version {meevax::string::static_concat("${PROJECT_VERSION_MINOR}")};
constexpr auto patch_version {meevax::string::static_concat("${PROJECT_VERSION_PATCH}")};

constexpr auto version {meevax::string::static_concat("${PROJECT_VERSION}")};

constexpr auto boost_major_version {meevax::string::static_concat("${Boost_MAJOR_VERSION}")};
constexpr auto boost_minor_version {meevax::string::static_concat("${Boost_MINOR_VERSION}")};
constexpr auto boost_patch_version {meevax::string::static_concat("${Boost_SUBMINOR_VERSION}")};
